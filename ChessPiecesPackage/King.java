...
public class King extends Pieces{
    ...
    public King(int color, int ID, int[] coordinate) {
        ...
        component = new King.KingComponent(this);
    }
    ...
    public class KingComponent extends PiecesComponent {
        ...
        public KingComponent(Pieces pieces){
            ...
            if (this.getComponentColor() == CONTANTPARAMETERS.Black){
                pieceImage = new ImageIcon("C:\\Programming\\Java files\\JavaIntellij\\src\\Chess\\ChessPiecesElements\\KingBlack.png").getImage();
                STATICPARAMETERS.BlackKingID = this.ComID;
            }else{
                pieceImage = new ImageIcon("C:\\Programming\\Java files\\JavaIntellij\\src\\Chess\\ChessPiecesElements\\KingWhite.png").getImage();
